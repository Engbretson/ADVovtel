...
MIL_DLLFUNC void MFTYPE MfpgaSetDestination(   MIL_FPGA_CONTEXT FpgaCommandContext,
                                               MIL_BUFFER_INFO DstBuf,
                                               MIL_INT StreamOutputNumber,
                                               MIL_INT64 ControlFlag);

MIL_DLLFUNC void MFTYPE MfpgaSetLink(          MIL_FPGA_CONTEXT SrcFpgaCommandContext,
