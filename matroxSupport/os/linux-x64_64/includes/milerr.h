...
#define M_ERR_170_SUBMSG_4       MIL_TEXT("Parameters 3 to 8 must be set to M_DEFAULT.")
...
#define M_ERR_179_SUBMSG_5       MIL_TEXT("In overwirte mode, queue size must be 1.")
...
#define M_ERR_183_SUBMSG_2       MIL_TEXT("Mismatch buffer in a M_BUFFER_SEQUENCE container.")
#define M_ERR_183_SUBMSG_3       MIL_TEXT("Added component does not have the correct buffer purpose.")
#define M_ERR_183_SUBMSG_4       MIL_TEXT("Cannot add component to 3D scene.")
...
#define M_ERR_184_SUBMSG_5       MIL_TEXT("Invalid control type for this container buffer type.")
